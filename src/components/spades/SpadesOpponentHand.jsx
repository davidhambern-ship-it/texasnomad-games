...
export default function SpadesOpponentHand({ player, position }) {
  ...
  if (isHorizontal) {
    return (
      <div 
        className={`absolute z-5 flex justify-center ${
          position === 'top' ? 'top-20' : 'bottom-20'
        }`}
        style={{ 
          left: '50%', 
          transform: 'translateX(-50%)',
          width: Math.min(440, 50 + cardCount * 35),
          height: 100 
        }}
      >
  ...
  return (
    <div 
      ...
      style={{ 
        ...
        width: 100,
        height: Math.min(400, 50 + cardCount * 30)
      }}
    >
