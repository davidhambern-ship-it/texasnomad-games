    ...
    <div className="flex flex-col items-center p-4 gap-4 max-w-4xl mx-auto w-full">
      ...
      <div className="relative w-full bg-[#0a1a0a] rounded-3xl border-4 border-[#3d2817] overflow-visible"
        ...
        {getPlayerAtSeat(3)?.hand?.length > 0 && (
          <div className="absolute top-14 left-1/2 -translate-x-1/2 z-5 flex justify-center" style={{ width: 380, height: 100 }}>
        ...
        {getPlayerAtSeat(2)?.hand?.length > 0 && (
          <div className="absolute left-14 top-1/2 -translate-y-1/2 z-5 flex items-center" style={{ width: 100, height: 360 }}>
            <div className="flex flex-col" style={{ transform: 'scale(1.1) rotate(90deg)' }}>
        ...
        {getPlayerAtSeat(4)?.hand?.length > 0 && (
          <div className="absolute right-14 top-1/2 -translate-y-1/2 z-5 flex items-center" style={{ width: 100, height: 360 }}>
            <div className="flex flex-col" style={{ transform: 'scale(1.1) rotate(-90deg)' }}>
        ...
        {getPlayerAtSeat(1)?.hand?.length > 0 && (
          <div className="absolute bottom-14 left-1/2 -translate-x-1/2 z-5 flex justify-center" style={{ width: 420, height: 120 }}>
