...
export default function SpadesTable({ gs, playerId, mySeatNumber, myRole, isPlayer, isSpectator, updateState, availableSeats, onSitInSeat, roomCode, onPlayAgainstCPU, onWaitForRealPlayers, cpuChoiceShown, onChooseSpectate, onChooseSit, onPlayCard }) {
  ...
  return (
    <div className="flex flex-col items-center p-6 gap-6 max-w-6xl mx-auto w-full">
      ...
      {/* SET STATUS DISPLAY */}
      {isPlaying && (
        <div className="w-full px-4 py-3 rounded-xl border border-[#FFD700]/30 bg-[#FFD700]/5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="p-3 rounded-lg border border-[#BC13FE]/30 bg-[#BC13FE]/05">
              <div className="font-heading text-xs text-[#BC13FE] uppercase mb-2">{gs.team1Name || 'Team 1'}</div>
            ...
            <div className="p-3 rounded-lg border border-[#FF5F1F]/30 bg-[#FF5F1F]/05">
              <div className="font-heading text-xs text-[#FF5F1F] uppercase mb-2">{gs.team2Name || 'Team 2'}</div>
              <div className="text-[6px] space-y-1" style={PS2}>
                <div className="flex justify-between">
                  <span className="text-white/40">Bid:</span>
