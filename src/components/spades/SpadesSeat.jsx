...
export default function SpadesSeat({ 
  ...
  // Rotate the entire seat box so it faces its own seat position
  const rotationDeg = position === 'left' ? 90 : position === 'right' ? -90 : position === 'top' ? 180 : 0;

  return (
    <div className="flex flex-col items-center gap-1" style={{ transform: `rotate(${rotationDeg}deg)` }}>
      <div
