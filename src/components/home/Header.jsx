    ...
    <header className="sticky top-0 z-50 w-full border-b border-cyber-purple/30 bg-midnight-void/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <Link to="/" className="flex items-center gap-2 shrink-0">
          <img src="https://media.base44.com/images/public/6a1faf9539e2c1e12925ead8/1954440a1_logoimage-3-nobg.png" alt="TexasNomad Logo" className="w-8 h-8 sm:w-10 sm:h-10 object-contain" />
