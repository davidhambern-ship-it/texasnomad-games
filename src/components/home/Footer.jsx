    ...
    <footer className="border-t border-cyber-purple/30 bg-midnight-void px-4 sm:px-6 py-6">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <span className="font-heading text-sm tracking-widest text-white uppercase">TEXASNOMAD</span>
            <span className="block font-heading text-[8px] tracking-[0.3em] text-kinetic-orange uppercase">PRODUCTIONS</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <a href="https://youtube.com/@bernatune?si=meQWazY1fXAjPeF0" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-white/60 hover:text-red-500 transition-colors text-sm">
          ...
          <a href="https://www.bigo.tv/daberna" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-white/60 hover:text-cyber-purple transition-colors text-sm">
        ...
        {/* Copyright */}
        <p className="font-heading text-xs tracking-widest text-white/40 uppercase">
